...
public record TaskResponse(string Id, string Code, string Type, string Level, string Location, string Direction, string Time, int Status, string? Description, string? Script);
public record TaskDetailResponse(string Id, string Code, string Type, string Level, string Location, string Direction, string Time, int Status, string Description, string Script, List<StatusLogEntry> StatusLog);
public record StatusLogEntry(string Time, string Text, string Actor);
public record StatusUpdateRequest(int Status, string Actor);
